...
namespace PostDarkness
{
    public class TerranioreSystem : ModSystem
    {
        ...
        private void GenerateTerraniore()
        {
            ...
            for (int i = 0; i < (int)(Main.maxTilesX * Main.maxTilesY * 0.00005); i++) // Set frequency
            {
        ...
        {  
            ...
            if (Main.tile[x, y].TileType == TileID.JungleGrass || Main.tile[x, y].TileType == TileID.JunglePlants || Main.tile[x, y].TileType == TileID.JungleVines)
            {
                return true;
            }
